...
<title>Reservation Detail Detail List</title>
<script>
	function goBack() {
		window.history.back();
	}
...
<body>
	...
	%>
	<!-- 	<a href="userHomePage.jsp" class="gujju-green gujju-btn">Home</a> <br> -->
		<br>
		<table
			style="width: 45%; margin: 0 auto; font-family: 'Trebuchet MS'; font-size: 18px; color: rgba(70, 70, 70, 1); background-image: url('DigitalGSRTC-photos/logo1.png'); background-repeat: no-repeat; background-position: -40px 150px; background-size: 400px 210px;">
			...
			<tr>
				<td colspan="2"
					style="padding: 10px 0; text-align: center; text-transform: uppercase; font-weight: 900; font-size: 26px;"><%=reservationBean.getFirstName()%>
					<%=reservationBean.getMiddleName()%> <%=reservationBean.getLastName()%></td>
			</tr>
			<tr>
				<td style="font-weight: 900;">Email Id</td>
				<td style="text-align: center;"><%=reservationBean.getEmail()%></td>
			</tr>
			<tr>
				<td style="font-weight: 900;">Source</td>
				<td style="text-align: center;"><%=reservationBean.getSourceName()%></td>
			</tr>
			<tr>
				<td style="font-weight: 900;">Destination</td>
				<td style="text-align: center;"><%=reservationBean.getDestinationName()%></td>
			</tr>
			<tr>
			...
			<tr>
				<td style="font-weight: 900;">IsCancle</td>
				...
				<td style="text-align: center;">
					<%
						ArrayList<ReservationDetailBean> listOfreservationDetail = (ArrayList) request
													.getAttribute("listofReservationDetails");
