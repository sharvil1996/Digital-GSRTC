...
%>
	<div>
		...
		<div class="gujju-third">
			<div style="font-size: 20px; font-stretch: ultra-condensed;"
				class="col-md-10 text-info">
				<center>
					Search For Bus <span class="fa-search fa"></span>
				</center>
			</div>
			<form action="GuestScheduleListServlet" method="post"
					...
					<div class="gujju-row">
						<div class="col-lg-10">
							...
							<div class="col-lg-8">
								...
								<input list="Source" name="selSourceName" maxlength="13"
									style="text-transform: capitalize;" placeholder="Source"
									class="form-control" autocomplete="off" value="${sourceName}" />
								...
								%> </datalist>
								<div class="gujju-text-red text-uppercase">${msgSourceName}</div>
						...
						<div class="col-lg-10">
							...
							<div class="col-lg-8">
								<input list="Destination" placeholder="Destination"
									name="selDestinationName" maxlength="13" class="form-control"
									style="text-transform: capitalize;" autocomplete="off"
									value="${DestinationName}" />
								<datalist id="Destination"> <% stationBeansList = new StationDAO().list();
					...
					<div class="gujju-row ">
						<div class="col-lg-9 ">
							<button type="submit"
								...
								value="Search Bus">
								<i class="fa-search fa">&emsp; Search </i>
							</button>
							<br /> <br />
						</div>
					</div>
					...
					<div id="myCarousel" class="carousel slide" data-ride="carousel">
						...
						<div class=" carousel-inner" role="listbox">
							<div class="item active ">
								<img src="photo/slid (2).jpg" alt="Chania" />
							</div>
							<div class="item">
