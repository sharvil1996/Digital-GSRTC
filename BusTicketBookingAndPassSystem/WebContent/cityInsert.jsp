			...
			<form action="CityInsertServlet" method="post">
				<div class="row">
					<div class="col-lg-10">
						...
						<div class="col-lg-6">
							<input type="text" size="30" maxlength="15" class="form-control"
								name="txtCityName" placeholder="Enter city name" oninput="space(this);onlytext(this); nodigit(this);"/>
					</div><font color="red">${cityName}</font><br>
				</div>
				<br></br><br><br>
