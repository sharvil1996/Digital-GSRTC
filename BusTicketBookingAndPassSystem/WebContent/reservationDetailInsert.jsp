...
<div style="margin-top: -850px;margin-left: 250px;">
	...
	<h1>
		Reservation Detail <small>Insert</small>
	</h1>
	<ol class="breadcrumb">
		...
		<form name="reservation" method="post">
			...
			<div style="margin-top: -460px;margin-left: 900px;">
				<input type="button" id="btnShowNew" class="btn btn-success"
					value="Submit" />
			...
			$(function() {
				...
				$('#btnShowNew').click(
						function() {
							...
							alert(str.join(','));
							document.reservation.action = "ReseravationDetailInsertServlet?seatId=" + str;
