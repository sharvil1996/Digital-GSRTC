...
<div style="margin-top: -850px;margin-left: 250px;">
	...
	<div class="col-lg-6">
		<div class="container">
			<form action="UserInsertServlet" method="post" name="Registration">
				<br />
				<div class="row ">
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<input type="text" class="form-control" name="txtMobileNo"
							...
							value="${txtmobileNo}" oninput="space(this);onlydigit(this);" /> 
						<font color="red">${mobileNo}
						</font>
					</div>
				</div>
				<br />
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<textarea rows="3" class="form-control" cols="18" name="txtAddress">${txtAddress}</textarea>
