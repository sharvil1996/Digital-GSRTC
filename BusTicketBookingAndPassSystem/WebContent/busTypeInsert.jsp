...
<title>Admin | BusType Insert</title>
					...
					<div class="col-lg-10">
						...
						<div class="col-lg-6">
							<input type="text" size="30" maxlength="7" class="form-control"
								name="txtBusTypeName" placeholder="Enter Bus Type" oninput="space(this);onlytext(this); nodigit(this);"/>
					</div><font color="red">${busTypeName}</font><br>
				</div>
				<br></br><br>
				<br>
