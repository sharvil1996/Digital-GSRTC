	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			FileOutputStream fout = new FileOutputStream(
					new File("E:\\BusTicketBookingAndPassSystem\\WebContent\\upload\\QRCode\\ReNew\\"+passBean.getFirstName()+" "+passBean.getMiddleName()+" "+passBean.getLastName()+".gif"));
		...
		response.sendRedirect("renewPassPrint.jsp");
