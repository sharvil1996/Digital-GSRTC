...
protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	...
	String userId="",sourceId="",destinationId="",passTypeId="",validity="",orgnizationId="",fileName = null,passId="",firstName="";
	...
	{	
		...
		if(item.isFormField())
		{
			...
			fieldValue=item.getString();
				...
				else if(fieldName.equals("passId"))
				{
					passId=fieldValue;
				}
		...
		else
		{
			...
			String path="E:\\ProjectSem6\\BusTicketBookingAndPassSystem\\WebContent\\upload\\pass\\";
	...
	if(isError)
	{
		passBean.setPassId(passId);
		passBean.setFirstName(firstName);
	...
	else
	{
		...
		if(new PassDAO().update(passBean) )
		{
